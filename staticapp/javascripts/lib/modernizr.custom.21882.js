 ...
 * Build http://v3.modernizr.com/download/#-animation-apng-appearance-applicationcache-audio-audioloop-audiopreload-backgroundblendmode-backgroundcliptext-backgroundsize-bgpositionshorthand-bgpositionxy-bgrepeatspace_bgrepeatround-bgsizecover-blobworkers-borderimage-borderradius-boxshadow-boxsizing-canvas-canvasblending-canvastext-canvaswinding-checked-contains-contextmenu-cookies-cors-createelementattrs_createelement_attrs-cssanimations-csscalc-csschunit-csscolumns-cssexunit-cssfilters-cssgradients-csshyphens_softhyphens_softhyphensfind-cssinvalid-cssmask-csspointerevents-csspositionsticky-csspseudoanimations-csspseudotransitions-cssreflections-cssremunit-cssresize-cssscrollbar-csstransforms-csstransforms3d-csstransitions-cssvalid-cssvhunit-cssvmaxunit-cssvminunit-cssvwunit-cubicbezierrange-customevent-customprotocolhandler-dataview-dataworkers-details-devicemotion_deviceorientation-display_runin-displaytable-draganddrop-ellipsis-emoji-es5-es5array-es5date-es5function-es5object-es5string-es5syntax-es5undefined-es6array-es6math-es6number-es6object-es6string-eventlistener-exiforientation-filereader-filesystem-flash-flexbox-flexboxlegacy-flexboxtweener-flexwrap-fontface-formvalidation-framed-fullscreen-generatedcontent-generators-geolocation-getusermedia-hashchange-hiddenscroll-hsla-htmlimports-ie8compat-inlinesvg-inputtypes-json-lastchild-localstorage-mediaqueries-multiplebgs-mutationobserver-nthchild-objectfit-opacity-overflowscrolling-preserve3d-promises-regions-requestautocomplete-rgba-sandbox-seamless-shapes-siblinggeneral-smil-srcdoc-strictmode-subpixelfont-supports-svg-svgasimg-svgclippaths-svgfilters-svgforeignobject-target-template-textalignlast-textareamaxlength-textshadow-texttrackapi_track-todataurljpeg_todataurlpng_todataurlwebp-touchevents-userdata-userselect-video-videoautoplay-videoloop-videopreload-vml-webaudio-webgl-webglextensions-webp-webpalpha-webpanimation-webplossless_webp_lossless-websockets-webworkers-willchange-wrapflow-xhr2-xhrresponsetype-xhrresponsetypearraybuffer-xhrresponsetypeblob-xhrresponsetypedocument-xhrresponsetypejson-xhrresponsetypetext-addtest-domprefixes-hasevent-mq-prefixed-prefixedcss-prefixes-shiv-testallprops-testprop-teststyles-dontmin
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
